...
const imageBreakPoints = ["1024px", "768px", "640px"]
...
export const screenMedia = {
  large: `screen and (max-width: ${imageBreakPoints[0]})`,
  medium: `screen and (max-width: ${imageBreakPoints[1]})`,
  small: `screen and (max-width: ${imageBreakPoints[2]})`,
}
